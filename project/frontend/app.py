...
with col1:
    ...
    fwd_packet_length_mean = st.number_input("Fwd Packet Length Mean", min_value=0.0, value=None, step=1.0, placeholder="값을 입력 하세요")
    bwd_packet_length_mean = st.number_input("Bwd Packet Length Mean", min_value=0.0, value=None, step=1.0, placeholder="값을 입력 하세요")

with col2:
    flow_bytes_s = st.number_input("Flow Bytes/s", min_value=0.0, value=None, step=1.0, placeholder="값을 입력 하세요")
    flow_packets_s = st.number_input("Flow Packets/s", min_value=0.0, value=None, step=1.0, placeholder="값을 입력 하세요")
    flow_iat_mean = st.number_input("Flow IAT Mean", min_value=0.0, value=None, step=1.0, placeholder="값을 입력 하세요")
    packet_length_mean = st.number_input("Packet Length Mean", min_value=0.0, value=None, step=1.0, placeholder="값을 입력 하세요")
